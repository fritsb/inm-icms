...
function ColorPicker() {
	...
	// Object variables
	if(arguments[1] != null && arguments[1].value != null)
		cp.currentValue = arguments[1].value;
	else
	...
	if (windowMode) {
		cp_contents += "<HTML><HEAD><TITLE>Kies een kleur uit</TITLE></HEAD>\n";
		cp_contents += "<BODY MARGINWIDTH=0 MARGINHEIGHT=0 LEFTMARGIN=0 TOPMARGIN=0><CENTER>\n";
		}
	cp_contents += "<TABLE STYLE=\"border: solid 1px #336699;\" CELLSPACING=1 CELLPADDING=0>\n";
	cp_contents += "<TR><TD colspan=\"18\" style=\"background-color: #336699; color: white; font-family: Verdana; font-size: 12px; font-weight: bold; text-align: center;\">Kies een kleur uit</TD></TR>\n";
	var use_highlight = (document.getElementById || document.all)?true:false;
	for (var i=0; i<total; i++) {
		if ((i % width) == 0) { cp_contents += "<TR>"; }
		if (use_highlight) { var mo = 'onMouseOver="'+windowRef+'ColorPicker_highlightColor(\''+colors[i]+'\',window.document)"'; }
		else { mo = ""; }
		cp_contents += '<TD BGCOLOR="'+colors[i]+'" style=\"font-family: Verdana; font-size: 12px; font-weight: bold;\"><A HREF="#" onClick="'+windowRef+'ColorPicker_pickColor(\''+colors[i]+'\','+windowRef+'window.popupWindowObjects['+cp.index+']);return false;" '+mo+' STYLE="text-decoration:none;">&nbsp;&nbsp;&nbsp;</A></TD>\n';
	...
	if (document.getElementById) {
		...
		cp_contents += "<TR><TD COLSPAN='"+width1+"' BGCOLOR='"+cp.currentValue+"' ID='colorPickerSelectedColor'>&nbsp;</TD><TD COLSPAN='"+width2+"' ALIGN='CENTER' ID='colorPickerSelectedColorValue' style=\"font-family: Verdana; font-size: 12px; font-weight: bold;\">"+cp.currentValue+"</TD></TR>\n";
		}
	cp_contents += "</TABLE>\n";
	if (windowMode) {
