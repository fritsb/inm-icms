 ...
 * 
 * Bestandsnaam: MySQLiDatabaseConnectie.inc.php
 * Beschrijving: De MySQLiDatabaseConnectie klasse voor verbinding met MySQL-database mbv de Improved MySQL Extension. 
...
class MySQLiDatabaseConnectie extends mysqli {
